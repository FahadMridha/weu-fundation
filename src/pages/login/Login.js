  ...
  return (
    <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100 mx-auto my-5 mt-[100px]">
      ...
      >
        ...
        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400 hover:bg-violet-700">
      ...
      <div>
        ...
        {error && (
          <p className="text-red-500 font-bold">{error?.message?.slice(9)}</p>
        )}
      </div>
      {/* google part */}
